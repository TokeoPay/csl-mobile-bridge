...
public class CSLKit {
    ...
    private static func createError(from errorPtr: CharPtr?, code: Int = 1) -> Error {
    ...
    @RustBinding("csl_bridge_address_from_bech32") private static func _addressFromBech32(bech_str_str p1: String) throws -> OpaqueRustPointer<CSL_Address> {fatalError()}
//    @RustBinding("csl_bridge_address_from_bytes") private static func _addressFromBytes(data_data p1: Data, data_len p2: UInt64) throws -> OpaqueRustPointer<CSL_Address> {fatalError()}
    @RustBinding("csl_bridge_address_to_json") private static func _addressToJson(self_rptr p1: OpaqueRustPointer<CSL_Address>) throws -> String {fatalError()}
    @RustBinding("csl_bridge_address_from_json") private static func _addressFromJson(json_str p1: String) throws -> OpaqueRustPointer<CSL_Address> {fatalError()}
    @RustBinding("csl_bridge_address_kind") private static func _addressKind(self_rptr p1: OpaqueRustPointer<CSL_Address>) throws -> Int32 {fatalError()}
    @RustBinding("csl_bridge_address_payment_cred") private static func _addressPaymentCred(self_rptr p1: OpaqueRustPointer<CSL_Address>) throws -> OpaqueRustPointer<CSL_PaymentCred> {fatalError()}
    @RustBinding("csl_bridge_address_is_malformed") private static func _addressIsMalformed(self_rptr p1: OpaqueRustPointer<CSL_Address>) throws -> Bool {fatalError()}
    @RustBinding("csl_bridge_address_to_hex") private static func _addressToHex(self_rptr p1: OpaqueRustPointer<CSL_Address>) throws -> String {fatalError()}
    @RustBinding("csl_bridge_address_from_hex") private static func _addressFromHex(hex_str_str p1: String) throws -> OpaqueRustPointer<CSL_Address> {fatalError()}
//    @RustBinding("csl_bridge_address_to_bytes") private static func _addressToBytes(self_rptr p1: OpaqueRustPointer<CSL_Address>) throws -> DataPtr {fatalError()}
    @RustBinding("csl_bridge_address_to_bech32") private static func _addressToBech32(self_rptr p1: OpaqueRustPointer<CSL_Address>) throws -> String {fatalError()}
    
    @RustBinding("csl_bridge_fixed_transaction_to_hex") private static func _fixedTransactionToHex(self_rptr p1: OpaqueRustPointer<CSL_FixedTransaction>) throws -> String {fatalError()}
    @RustBinding("csl_bridge_fixed_transaction_from_hex") private static func _fixedTransactionFromHex(hex_str_str p1: String) throws -> OpaqueRustPointer<CSL_FixedTransaction> {fatalError()}
    
    
    public static func fixedTransactionRawBody(self_rptr p1: OpaqueRustPointer<CSL_FixedTransaction>) throws -> Data {
        var p0 = p1.cPointer
        var result = DataPtr()
        var error: CharPtr? = nil
        let success = csl_bridge_fixed_transaction_raw_body(p0, &result, &error)
        if success {
...
//    /*@RustBinding("csl_bridge_fixed_transaction_raw_body") private static func _fixedTransactionRawBody(self_rptr p1: OpaqueRustPointer<CSL_FixedTransaction>) throws */-> DataPtr {fatalError()}
    ...
    @RustBinding("csl_bridge_transaction_hash_to_hex") private static func _transactionHashToHex(self_rptr p1: OpaqueRustPointer<CSL_TransactionHash>) throws -> String {fatalError()}
}
