...
//        }
        ...
        public static func constrPlutusDataNew(alternative_rptr p1: OpaqueRustPointer<Types.CSL_BigNum>, data_rptr p2: OpaqueRustPointer<Types.CSL_PlutusList>) throws -> OpaqueRustPointer<Types.CSL_None> {
            let c_p1 = p1.cPointer
            let c_p2 = p2.cPointer
            var result  = RPtr(_0: nil)
            var error: CharPtr? = nil
        ...
        public static func costModelToBytes(self_rptr p1: OpaqueRustPointer<Types.CSL_CostModel>) throws -> Data {
            let c_p1 = p1.cPointer
            var result  = try DataPtr.init(fromData: Data())
            var error: CharPtr? = nil
        ...
        public static func costModelFromBytes(bytes_data p1: Data) throws -> OpaqueRustPointer<Types.CSL_CostModel> {
            var c_p1_ptr = p1.withUnsafeBytes { $0.bindMemory(to: UInt8.self).baseAddress }!
            let c_p1_len = UInt(p1.count)
            var result  = RPtr(_0: nil)
            var error: CharPtr? = nil
        ...
        public static func costModelToHex(self_rptr p1: OpaqueRustPointer<Types.CSL_CostModel>) throws -> String {
            let c_p1 = p1.cPointer
            var result : CharPtr? = nil
            var error: CharPtr? = nil
        ...
        public static func costModelFromHex(hex_str_str p1: String) throws -> OpaqueRustPointer<Types.CSL_CostModel> {
        ...
        public static func costModelToJson(self_rptr p1: OpaqueRustPointer<Types.CSL_CostModel>) throws -> String {
            let c_p1 = p1.cPointer
            var result : CharPtr? = nil
            var error: CharPtr? = nil
        ...
        public static func costModelFromJson(json_str p1: String) throws -> OpaqueRustPointer<Types.CSL_CostModel> {
        ...
        public static func costModelNew() throws -> OpaqueRustPointer<Types.CSL_None> {
        ...
        public static func costModelLen(self_rptr p1: OpaqueRustPointer<Types.CSL_CostModel>) throws -> Int64 {
            let c_p1 = p1.cPointer
            var result  = Int64()
            var error: CharPtr? = nil
        ...
        public static func costmdlsToBytes(self_rptr p1: OpaqueRustPointer<Types.CSL_Costmdls>) throws -> Data {
            let c_p1 = p1.cPointer
            var result  = try DataPtr.init(fromData: Data())
            var error: CharPtr? = nil
        ...
        public static func costmdlsFromBytes(bytes_data p1: Data) throws -> OpaqueRustPointer<Types.CSL_Costmdls> {
            var c_p1_ptr = p1.withUnsafeBytes { $0.bindMemory(to: UInt8.self).baseAddress }!
            let c_p1_len = UInt(p1.count)
            var result  = RPtr(_0: nil)
            var error: CharPtr? = nil
        ...
        public static func costmdlsToHex(self_rptr p1: OpaqueRustPointer<Types.CSL_Costmdls>) throws -> String {
            let c_p1 = p1.cPointer
            var result : CharPtr? = nil
            var error: CharPtr? = nil
        ...
        public static func costmdlsFromHex(hex_str_str p1: String) throws -> OpaqueRustPointer<Types.CSL_Costmdls> {
        ...
        public static func costmdlsToJson(self_rptr p1: OpaqueRustPointer<Types.CSL_Costmdls>) throws -> String {
            let c_p1 = p1.cPointer
            var result : CharPtr? = nil
            var error: CharPtr? = nil
        ...
        public static func costmdlsFromJson(json_str p1: String) throws -> OpaqueRustPointer<Types.CSL_Costmdls> {
        ...
        public static func costmdlsLen(self_rptr p1: OpaqueRustPointer<Types.CSL_Costmdls>) throws -> Int64 {
            let c_p1 = p1.cPointer
            var result  = Int64()
            var error: CharPtr? = nil
        ...
        public static func credentialFromKeyhash(hash_rptr p1: OpaqueRustPointer<Types.CSL_Ed25519KeyHash>) throws -> OpaqueRustPointer<Types.CSL_None> {
            let c_p1 = p1.cPointer
            var result  = RPtr(_0: nil)
            var error: CharPtr? = nil
        ...
        public static func credentialToKeyhash(self_rptr p1: OpaqueRustPointer<Types.CSL_Credential>) throws -> OpaqueRustPointer<Types.CSL_KeyHash> {
            let c_p1 = p1.cPointer
            var result  = RPtr(_0: nil)
            var error: CharPtr? = nil
